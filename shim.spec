...
Source2  : https://github.com/rhboot/shim/releases/download/15.8/shim-15.8.tar.bz2.asc
Source3  : A348D61BC2713E9F.pkey
...
mkdir -p gnu-efi
cp -r %{_builddir}/gnu-efi-shim-15.7/* %{_builddir}/shim-15.8/gnu-efi
%patch -P 1 -p1
%patch -P 2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715715875
